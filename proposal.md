...
| Req | Detalle |
| --- | --- |
| CRUD | 1. CRUD Socio  2. CRUD Actividad  3. CRUD Instructor  4. CRUD Plan de Membresía  5. CRUD Membresía {depende de} CRUD Socio y CRUD Plan de Membresía  6. CRUD Turno {depende de} CRUD Actividad y CRUD Instructor  7. CRUD Ejercicio  8. CRUD Rutina {depende de} CRUD Socio, CRUD Instructor y CRUD Ejercicio  9. CRUD InscripcionTurno {depende de} CRUD Socio y CRUD Turno |
